...
export const ICON_LIBRARY: IconMetadata[] = [
  ...
  { name: 'exclamation-circle', label: 'Exclamation Circle', category: 'error' },
  { name: 'alert-triangle', label: 'Alert Triangle', category: 'warning' },
  { name: 'exclamation-triangle', label: 'Exclamation Triangle', category: 'warning' },
  { name: 'information-circle', label: 'Information Circle', category: 'info' },
  { name: 'question-mark-circle', label: 'Question Mark Circle', category: 'info' },
...
export function getIconsByCategory(category: IconMetadata['category']): IconMetadata[] {
